...
import com.udacity.gradle.builditbigger.androidmodule.AndroidActivity;
import com.udacity.gradle.builditbigger.backend.myApi.MyApi;
import com.udacity.gradle.builditbigger.javamodule.MyJoke;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void tellJoke(View view) {
      /*  Intent intent = new Intent(this,AndroidActivity.class);
        intent.putExtra(Intent.EXTRA_TEXT,funnyJoke);
        Toast.makeText(this, funnyJoke, Toast.LENGTH_SHORT).show();
